...
##############################################################################3
	...
	public function login_asesor(){
		$asesor = $this->session->userdata('level');
		if($asesor=='Asesor'){
			return TRUE;
		}
	}

	public function login_komite(){
		$asesor = $this->session->userdata('level');
		if($asesor=='Komite'){
			return TRUE;
		}
...
#############################################################################################################
	...
	// public function ustkm_tt(){
	// 	$id_propinsi = $this->session->userdata('id_propinsi');
	// 	$id_asosiasi = $this->session->userdata('id_asosiasi');
	// 	$level = $this->session->userdata('level');
	// 	$jenis_asosiasi = $this->session->userdata('jenis_asosiasi');
	// 	if($id_propinsi!='00' AND $id_asosiasi!='000' AND $id_asosiasi!='001' AND $jenis_asosiasi=='TT' AND $level=='9'){
	// 		return true;
	// 	}
	// }
	...
	{
		$data = $this->User_model->selectwhere($this->session->userdata('id_user'));
		return $data;
	}

	public function datapropinsi($id)
	{
		$data = $this->Asesor_model->namapropinsi($id);
		return $data;
	}
