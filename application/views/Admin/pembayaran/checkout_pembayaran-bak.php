...
<div class="col-md-6" style="margin-top:50px;">
    <div class="card">
      <div class=" p-3">
        <h4>Permohonan Pembayaran Biaya Sertifikasi SKK-K</h4>
      </div>
      <hr class="mt-0 line">
      ...
      Pembayaran untuk Permohonan Sertifikasi SKK-K :
      <div class="p-3">
        <div class="d-flex justify-content-between mb-2">
          <span>ID-Izin</span>
          <span><?= $id_izin;?></span>
      ...
      <div style="text-align:left; font-size:12px;">
        Catatan :<br/>
        Batas Waktu Pembayaran yaitu 7 Hari Kerja, Jika melebih dari yang ditentukan Permohonan Sertifikasi SKK akan otomatis ditolak.<br/><br/>
      </div>
  ...
  <form action="<?= base_url('pembayaran/upload_surat_perjanjian_sertifikasi/').base64_encode($id_izin);?>" method="POST" enctype="multipart/form-data">
    ...
    <?php if(empty($get_data_surat_perjanjian_sertifikat->file)){ ?>
      <a href="<?= base_url('assets/draf_dokumen/Draft SURAT PERJANJIAN SERTIFIKASI.docx')?>" class="btn btn-warning" style="font-size:12px;">Download Draf Surat Perjanjian Sertifikasi Disini</a><br/><br/>
