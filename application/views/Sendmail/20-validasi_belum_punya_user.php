...
<body>
    ...
    <b><i>Catatan Penting : Terlampir dibawah Merupakan User Login LSP <?= $get_data_lsp->username;?> untuk melengkapi keperluan Permohonan SKK yaitu APL-01 dan APL-02, user ini juga nantinya digunakan untuk Permohonan SKK yang lain yang anda Mohonkan</i><b><br/><br/> 
    Username : <?= $username;?><br/>
    Password : <?= $password;?><br/><br/>

    Silahkan Klik Tombol dibawah ini untuk ke bagian halaman Login<br/>
    <a href="<?= base_url();?>"><button style="border:none; padding:10px 30px; background-color:#3234fb; color:#fff; border-radius:10%;">Login</button></a><br/><br/>
